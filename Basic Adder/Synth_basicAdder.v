...
// Date      : Tue Dec 12 15:16:36 2023
/////////////////////////////////////////////////////////////


module basicAdder_DW01_add_0 ( A, B, CI, SUM, CO );
  input [32:0] A;
  input [32:0] B;
  output [32:0] SUM;
  input CI;
...
module basicAdder ( A, B, Cin, S, Cout, overFlow );
  input [31:0] A;
  input [31:0] B;
  output [31:0] S;
  input Cin;
  ...
  basicAdder_DW01_add_0 add_1_root_add_10_2 ( .A({1'b0, A}), .B({1'b0, B}), 
        .CI(Cin), .SUM({Cout, S}) );
  NOR2X0 U6 ( .IN1(n5), .IN2(n6), .QN(N36) );
